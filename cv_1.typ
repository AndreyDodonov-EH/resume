...
#let bullet(body) = {
  grid(
    columns: (3.5mm, 1fr),
    gutter: 0pt,
    align(left + horizon, circle(radius: 1.2pt, fill: accent)),
...
#let sub-bullet(body) = {
  grid(
    columns: (5mm, 1fr),
    gutter: 0pt,
    align(right + horizon, pad(right: 1.5mm, text(8.5pt, fill: rgb("#888888"), "–"))),
...
#grid(
  ...
  rect(
    ...
    #par(justify: true, leading: 0.5em, text(8.5pt, fill: summary-fg)[
      *12+ years* of system design with constrained resources, specializing in\
      embedded, web development and blockchain technologies.\
