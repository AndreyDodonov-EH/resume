...
#grid(
  ...
  rect(
    ...
    #v(0.8mm)
    #text(7.5pt, fill: rgb("#777777"), tracking: 0.3pt)[Embedded · Rust · Blockchain · Full Stack · Industrial IoT]
    ...
    #job-header("Open Source", "")

    #bullet[
      *#link("https://oh-rust.com")[Oh-Rust] — Rust compiler fork with snarky error messages*\

    ]

    #bullet[
      *#link("https://github.com/zephyrproject-rtos/zephyr")[Zephyr RTOS] — contributions to networking subsystem*\

    ]

    #bullet[
      *#link("https://github.com/gitextensions/gitextensions")[GitExtensions] — contributions to popular Git GUI*\
